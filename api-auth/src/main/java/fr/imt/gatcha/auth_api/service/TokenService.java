package fr.imt.gatcha.auth_api.service;

import fr.imt.gatcha.auth_api.domain.AppUser;
import fr.imt.gatcha.auth_api.domain.Token;
import fr.imt.gatcha.auth_api.repository.AppUserRepository;
import fr.imt.gatcha.auth_api.repository.TokenRepository;
...
public class TokenService {
    ...
    public String issueToken(AppUser user) {
        ...
        String tokenString = user.getId() + expires.toString();
